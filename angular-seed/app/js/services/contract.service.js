(function() {
    ...
    myApp.services.factory('ContractService', ['Web3Service', 'ContractConfig', '$q', ContractService]);
    ...
    function ContractService(web3, ContractConfig, $q) {
        ...
        const DEFAULT_SEED_HASH = "0x974f963ee4571e86e5f9bc3b493e453db9c15e5bd19829a4ef9a790de0da0015";
                    ...
                    if (methodAbi.constant) {
                        ...
                        self.web3.eth.getTransactionCount(ctx.tx.from, 'pending', function(err, nonce) {
                            ...
                            var txRlp = EthUtils.createTx({
                                ...
                                pkey: DEFAULT_SEED_HASH, //ctx.client.seedHash,
                                to: contract.address
                            });
...
function test ()
{
        ...
        window.web3.setProvider(new window.web3.providers.HttpProvider('http://jobmarket.on.ether.camp:8555/sandbox/38f6a888ec1b44c10a63af21ef6c4cac52ca4199'))
